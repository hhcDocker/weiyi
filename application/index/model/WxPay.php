...
class WxPay extends Model
{
	private function _weixin_config(){//微信支付公共配置函数
		define('WXPAY_APPID', "wx2e5e0bc7a21dc9d3");//微信公众号APPID
		define('WXPAY_MCHID', "1322116201");//微信商户号MCHID
		define('WXPAY_KEY', "j665Gf5489PD09fW234k5X9oG434fb9n");//微信商户自定义32位KEY
