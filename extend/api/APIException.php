...
class APIException extends \Exception {
    ...
    public static $code_array = [
      ...
      /*===================================================================*/
          ...
          30002 => '链接不合法，请检查链接',
          30003 => '链接不可访问，请检查链接',
          30004 => '此链接非淘宝天猫链接，请检查链接',
          30005 => '此链接非淘宝天猫店铺链接，请检查链接',
          30006 => '请求被拒绝，请检查链接',
          30007 => '此链接非淘宝天猫店铺首页地址，请检查链接',
          30008 => '此链接非淘宝店铺店铺首页地址，请检查链接',
          ...
          30026 => '淘宝官方链接',
          30027 => '非本账号所购服务',
          30028 => '服务已被删除，请联系微驿客服',
          30029 => '请先转换网址',
          30030 => '请输入移动端网址',
          30031 => '此链接不是天猫或淘宝店铺首页地址，请确认后重试！',




          31009 => '获取商品详情信息失败，稍后再试1',
          32009 => '获取商品详情信息失败，稍后再试2',
          33009 => '获取商品详情信息失败，稍后再试3',
          34009 => '获取商品详情信息失败，稍后再试4',
          35009 => '获取商品详情信息失败，稍后再试5',
      /*===================================================================*/
          40001 => "用户ID不能为空",
          40002 => "凭据不合法或者已过期",
          40003 => "凭据不能为空",
